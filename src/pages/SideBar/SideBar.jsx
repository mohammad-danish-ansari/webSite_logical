...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  const menuItems = [
    { icon: Users, label: 'Logical', path: '/', active: location.pathname === '/' },
  ];
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
              ...
              {isOpen && (
                <span className="ml-3 text-xl font-semibold text-gray-900">Logical Inc</span>
              )}
            </div>
            <button
              onClick={onToggle}
          ...
          {menuItems.map((item, index) => {
            ...
            return (
              <div
                ...
                className={`
                  flex items-center px-4 py-3 mx-2 rounded-lg cursor-pointer transition-colors group relative
